...
var _manifest = __webpack_require__(23);
...
if (true) {
    ...
    var webpackConfig = __webpack_require__(31);
    var webpackCompiler = webpack(webpackConfig);
    app.use(__webpack_require__(34)(webpackCompiler, {
    ...
    app.use(__webpack_require__(35)(webpackCompiler));
}
...
app.get('*', function (req, res) {
    var context = {};
    var markup = _server2.default.renderToString(_react2.default.createElement(_reactRouterDom.StaticRouter, { location: req.url, context: context }, _react2.default.createElement(_App.App, null)));
    if (context.url) {
        // Somewhere a `<Redirect>` was rendered
        res.redirect(301, context.url);
    } else {
        res.send(renderHTML(markup, (0, _store.configureStore)()));
    }
});
function renderHTML(markup, store) {
    var html = _server2.default.renderToString(_react2.default.createElement(_Html.Html, { markup: markup, manifest: _manifest2.default, store: store }));
...
module.exports = {"app.js":"js/app.js","app.js.map":"js/app.js.map"}
...
var Html = exports.Html = function Html(props) {
    ...
    var renderScripts = _react2.default.createElement('script', { src: '/public/' + manifest['app.js'] });
    var initialState = _react2.default.createElement('script', { dangerouslySetInnerHTML: {
            __html: 'window.__INITIAL_STATE__=' + JSON.stringify(store.getState()) + ';'
        }, charSet: 'UTF-8' });
    return _react2.default.createElement('html', null, _react2.default.createElement('head', null, head.base.toComponent(), head.title.toComponent(), head.meta.toComponent(), head.link.toComponent(), head.script.toComponent(), _react2.default.createElement('link', { rel: 'shortcut icon', href: '/favicon.ico' })), _react2.default.createElement('body', null, _react2.default.createElement('main', { id: 'app', dangerouslySetInnerHTML: { __html: markup } }), initialState, renderScripts));
};
...
function configureStore() {
    ...
    var composeEnhancers = "development" !== 'production' && (typeof window === 'undefined' ? 'undefined' : _typeof(window)) === 'object' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || _redux.compose;
    var store = (0, _redux.createStore)((0, _ramda.always)({}), {}, composeEnhancers(_redux.applyMiddleware.apply(undefined, middlewares)));
    if (false) {
        module.hot.accept('./reducers', function () {
            // store.replaceReducer((require('./reducers')))
            store.replaceReducer((0, _ramda.always)({}));
        });
    }
    return store;
}
...
const ManifestPlugin = __webpack_require__(32)
const CheckerPlugin = __webpack_require__(33).CheckerPlugin
